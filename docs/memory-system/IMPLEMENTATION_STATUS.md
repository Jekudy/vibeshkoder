...
**Last updated:** 2026-05-27 (T12-08 merged + T12-07 closure docs — /butler_undo full implementation, 5 rollback kinds, migrations 077+078, 115 tests green, 3-round dual-model review, PR #351 pending merge.)
...
**Phase 12.5 carryovers (T12-07 fix sprint, 2026-05-30):**
- T12-09 carryover: live-PG exercise of `_resolve_prior_text` JOIN + `_cascade_butler_undo_invocations` UPDATE — today mock-only; real DB integration deferred to T12-09 binding sprint.
