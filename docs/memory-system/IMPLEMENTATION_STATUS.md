...
**Last updated:** 2026-05-27 (T12-08 docs gate — TTL expiry worker + per-user budget + monthly call_type filter + rate bucket exhaustiveness, 80 tests, PR #350 pending merge.)
