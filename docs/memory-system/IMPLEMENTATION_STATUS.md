...
**Last updated:** 2026-05-28 (T12-07 — rollback + `/butler_undo`: `undo_action` state machine, 5 inverse kinds, immutable parent + linked child row, C10.b citation inheritance, 22 new tests, no migration, PR pending.)
