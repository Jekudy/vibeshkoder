...
### §3.5 PR & merge rules
- Critical governance applies to all 3 orchestrators because they bind privacy invariants inside the memory system.
- Independent sprint PRs may run in parallel; merge only on green CI, with a Final Holistic Review at the end of every multi-sprint phase.
